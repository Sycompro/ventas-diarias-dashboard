    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50 animate-fade-in font-sans">
      ...
      <div className="hidden md:flex flex-col justify-between w-1/2 lg:w-[55%] bg-gradient-to-br from-slate-900 via-slate-800 to-primary-950 p-12 lg:p-20 relative overflow-hidden text-white">
        ...
        <div className="relative z-10 space-y-6 mt-12">
          <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm max-w-sm hover:bg-white/10 transition-colors">
          ...
          <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm max-w-sm hover:bg-white/10 transition-colors ml-8">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 md:p-12 relative bg-white">
        <div className="w-full max-w-md">
          ...
          {error && (
            <div className="mb-6 p-4 rounded-xl bg-danger-50 border border-danger-200 text-danger-700 text-sm flex items-start gap-3 animate-slide-up">
