...
export const DateRangePicker: React.FC = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-white p-2 border border-border-subtle rounded-lg shadow-sm">
      <div className="flex items-center gap-2 px-2 border-r border-border-subtle">
      ...
      <div className={`flex items-center gap-2 px-2 transition-opacity ${datePreset !== 'custom' ? 'opacity-50 pointer-events-none' : ''}`}>
        <input
          ...
          className="text-sm border-none bg-neutral-50 rounded px-2 py-1 focus:ring-1 focus:ring-primary outline-none"
        />
